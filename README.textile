...
<pre><code><?php $this->Form->create('User', array('type' => 'file')); ?>
	<?php $this->Form->input('User.username'); ?>
	<?php $this->Form->input('User.photo', array('type' => 'file')); ?>
<?php $this->Form->end(); ?>
</code></pre>
...
<pre><code><?php $this->Form->create('User', array('type' => 'file')); ?>
	<?php $this->Form->input('User.username'); ?>
	<?php $this->Form->input('User.photo', array('type' => 'file')); ?>
	<?php $this->Form->input('User.photo_dir', array('type' => 'hidden')); ?>
<?php $this->Form->end(); ?>
</code></pre>
...
* @randomPath@: If true, a random path is generated for each file upload. Does not persist across a record. If false, the record's primaryKey is used when creating the path for the file upload
