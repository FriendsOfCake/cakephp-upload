...
Now it is possible to generate a thumbnail for the first page in a PDF file. (Only works with 'imagick' thumbnailMethod.)
...
* @thumbnailType@: The type of image to generate thumbnails as
** Default: (string) @png@
